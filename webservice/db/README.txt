...
1. Run the 01-create-database.sh (Note this takes you into the sqlite command line interface).   "./filename" from konsole
...
- create your own insert statements to replace the authors to whoever you need.
- you don't want to check in a database, you want to check in the things that make the database.
